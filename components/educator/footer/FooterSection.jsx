...
export default function FooterSection() {
  ...
  return (
    <footer className="bg-background-primary overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-4 py-10">
        <div className="flex flex-col gap-4 items-center justify-center">
          <Link href="/">
            <Image
              src="/assets/educator/logos/logo-footer.svg"
          ...
          <p className="max-w-[55ch] text-center capitalize text-text-secondary">
            Whether in the classroom or through mentorship I am committed to
            guiding students toward success and making a meaningful impact in

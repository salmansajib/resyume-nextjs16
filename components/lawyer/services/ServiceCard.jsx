...
export default function ServiceCard({ item }) {
  return (
    <article className="group bg-linear-to-br from-[#4F4F4F]/52 to-[#1C1C1C]/52 w-full xl:w-[300px] h-[300px] rounded-lg flex flex-col gap-6 items-center justify-center hover:border-transparent hover:bg-primary">
      <div
        aria-hidden="true"

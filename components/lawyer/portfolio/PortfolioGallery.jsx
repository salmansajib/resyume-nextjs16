        ...
        {categories.map((category) => {
          ...
          return (
            <button
              ...
              className={`bg-linear-to-b from-[#4F4F4F] to-[#1c1c1c] px-12 py-3 rounded-full text-xl font-medium font-taviraj uppercase transition-colors duration-200 ease-in-out cursor-pointer hover:scale-105 ${
                isActive
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Swiper
              ...
              spaceBetween={32}
              slidesPerView={1}
              // Capture real slidesPerView value after init and every breakpoint change
              onInit={(swiper) => {
              ...
              // Conditional features — prevents "not enough slides" warning + broken loop

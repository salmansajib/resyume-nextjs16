      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-15 items-center justify-items-center">
        <div className="relative z-30 space-y-10 order-2 lg:order-1">
          ...
          <div className="space-y-12">
            ...
            <a
              href="#portfolio"
              className="uppercase border border-primary/25 px-12 py-3 rounded-full bg-background-neutral/23 text-2xl font-medium shadow-[inset_1px_1px_16px_0px_rgba(169,241,113,0.2)] hover:border-primary transition-colors duration-150"
            >
              check my portfolio
            </a>
          </div>

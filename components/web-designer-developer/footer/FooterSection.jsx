...
export default function FooterSection({ data }) {
  ...
  return (
    <footer className="relative z-10 py-10 bg-linear-to-br from-[#FFFEFE]/5 to-[#B49696]/0 flex flex-col sm:flex-row gap-10 items-start justify-center lg:block backdrop-blur-sm">
      {/* contact */}
      <div className="w-full lg:border-b border-text-secondary/30 max-w-max lg:max-w-full">
        <div className="w-full max-w-[1620px] mx-auto px-4 grid gap-5 lg:gap-0 grid-cols-1 lg:grid-cols-3">
          ...
          >
            <p className="font-rajdhani text-lg font-semibold uppercase group-hover:text-primary ">
              phone
            </p>

...
export default function ContactInfo({ heroData, className }) {
  return (
    <div
      className={cn(
        "bg-background-secondary w-[calc(100%-1rem)] max-w-[1642px] mx-auto px-5 sm:px-10 py-15 rounded-2xl ring-1 ring-primary/30 backdrop-blur-[7px] flex flex-col lg:flex-row items-center justify-center gap-5 lg:gap-15",
        className,
      )}
    >
      <h2 className="capitalize text-3xl font-semibold text-text-secondary">
        Contact Me
      </h2>
      <div className="flex flex-wrap lg:flex-nowrap items-center gap-5 lg:gap-10">
        ...
        >
          <span className="size-10 text-text-secondary ring-1 ring-primary/30 rounded-full flex items-center justify-center">
            <PhoneIcon />
          </span>

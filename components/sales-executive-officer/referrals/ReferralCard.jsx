...
export default function ReferralCard({ item, fadeInUp }) {
  return (
    <motion.div
      ...
      variants={fadeInUp}
      className="w-full max-w-[390px] bg-background-primary shadow-lg flex items-center justify-center px-4 pt-4 pb-8 rounded-xl ring-1 ring-[#E8E8E8]/10 backdrop-blur-xs"
    >
      <article className="space-y-3">
        ...
        <h3 className="text-xl font-semibold capitalize leading-none">
          {item.name}
        </h3>

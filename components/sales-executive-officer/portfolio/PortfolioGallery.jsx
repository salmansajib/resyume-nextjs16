...
export default function PortfolioGallery({ portfolioData }) {
  ...
  return (
    <div className="mt-15">
      {/* category */}
      <nav
        className="flex items-center flex-wrap justify-center gap-5 px-4"
      ...
      <div className="mt-10 financial-advisor-portfolio-slider">
        ...
        {shouldEnableLoopAndControls && (
          <div className="flex items-center justify-center gap-7 mt-10">
            {/* prev button */}
            <button
              className="swiper-button-prev-custom p-2 text-2xl font-medium transition-colors duration-150 cursor-pointer bg-background-primary hover:bg-primary hover:text-background-primary"
            ...
            {/* next button */}
            <button
              className="swiper-button-next-custom p-2 text-2xl font-medium transition-colors duration-150 cursor-pointer bg-background-primary hover:bg-primary hover:text-background-primary"

  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-20 gap-4">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-15 md:gap-30">
          ...
          <InViewAnimator variants={staggerContainer} className="relative">
            ...
            {/* left line */}
            <div className="w-px h-full bg-[#868686] absolute left-0 top-6"></div>
            <div className="w-10 h-px bg-[#868686] absolute left-0 top-6"></div>
          </InViewAnimator>
          ...
          <InViewAnimator variants={staggerContainer} className="relative">
            ...
            {/* left line */}
            <div className="w-px h-full md:h-[60%] bg-[#868686] absolute left-0 top-6"></div>
            <div className="w-10 h-px bg-[#868686] absolute left-0 top-6"></div>
          </InViewAnimator>
        </div>
      </div>
      ...
      <div aria-hidden className="absolute top-0 left-0">
        <Image
          src="/assets/hr-manager/images/bg-img-experience-top-left.svg"
          alt=""
          width={700}
          height={700}
          priority
      ...
      <div aria-hidden className="absolute bottom-0 right-0">
        <Image
          src="/assets/hr-manager/images/bg-img-experience-bottom-right.svg"
          alt=""
          width={700}
          height={700}
          priority

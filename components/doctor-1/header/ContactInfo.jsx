...
export default function ContactInfo({ heroData }) {
  return (
    <div className="space-y-5">
      ...
      >
        <div className="size-11 rounded-full border border-border-primary flex items-center justify-center group-hover:bg-primary group-hover:text-background-primary group-hover:border-primary transition-colors duration-150">
          <PhoneIcon />
        </div>

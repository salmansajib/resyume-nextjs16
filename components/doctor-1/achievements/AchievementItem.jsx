...
export default function AchievementItem({ item, onClick }) {
  return (
    <button
      onClick={onClick}
      className="bg-linear-to-br from-[#E8E6E5]/82 to-[#E9E9E9]/43 w-full h-[550px] p-4 rounded-lg group cursor-pointer overflow-hidden group flex flex-col items-center sm:block"
    >
      {/* image */}

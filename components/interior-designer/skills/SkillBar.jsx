...
export default function SkillBar({ name, percentage, delay = 0 }) {
  ...
  const startColor = "#BB9A65";
  const endColor = "#BB9A65";
    ...
    <div ref={ref} className="mb-8">
      ...
      <div className="flex justify-between items-center mb-5">
        <span
          ...
          className="font-medium text-text-primary uppercase"
        >
          {name}
        </span>

        <span
          className="text-base font-medium text-primary border border-text-primary border-dashed size-[47px] flex items-center justify-center"
      ...
      <div
        ...
        className="w-full h-6 border border-text-primary/50 flex items-center px-2 overflow-hidden"
      >
        <motion.div
          className="h-2"
          style={{

    ...
    <div className="group">
      ...
      >
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-colors duration-150 ease-in-out flex items-center justify-center rounded-xl overflow-hidden">
